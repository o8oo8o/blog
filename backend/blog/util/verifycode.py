...
class ValidCodeImg:
    ...
    def __init__(
        ...
        """
        self.font_file = os.path.join(os.path.dirname(__file__), font_file)
        self.width = width
        self.height = height
    ...
    def getValidCodeImg(self) -> tuple:
        ...
        data = f.getvalue()
        f.close()
        base64_str = str(base64.b64encode(data), encoding="utf-8")
        return data, valid_str, base64_str
