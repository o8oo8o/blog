...
<div>
    ...
    <div @click.stop id="chat_body" class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="margin-right: -51px; width: 280px;" >
        <div id="chat_box" class="card direct-chat direct-chat-info" >
            ...
            <div class="card-footer">
                <div class="input-group">
                    <input v-model.trim="send_msg" id="send_text" type="text" name="message" placeholder="消息内容" class="form-control">
    ...
    methods: {
        ...
        init: function () {
            if(typeof(WebSocket) === "undefined"){
                ...
                var sock_url = protocol+host+"/api/open/chat/?"+ document.cookie.replace(" ","").replace(";","&");
                // 实例化socket
